...
//    fun StoriesProgressView(context: Context?) {
//        this(context, null)
//    }
//
//    fun StoriesProgressView(context: Context, attrs: AttributeSet?) {
//        super(context, attrs)
//        init(context, attrs)
//    }
//
//    fun StoriesProgressView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
//        super(context, attrs, defStyleAttr)
//        init(context, attrs)
//    }
//
//    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
//    fun StoriesProgressView(
//        context: Context,
//        attrs: AttributeSet?,
//        defStyleAttr: Int,
//        defStyleRes: Int
